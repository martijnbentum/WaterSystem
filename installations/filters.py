...
class InstallationFilter(django_filters.FilterSet):
    un_name = django_filters.CharFilter(field_name='un_name', lookup_expr='icontains', 
		label='Name')
    watersystem__original_term = django_filters.CharFilter(lookup_expr='icontains', 
		label='Water system')
    ...
    institution_as_location__name = django_filters.CharFilter(lookup_expr='icontains', 
		label='Institution as location')
    secondary_literature__title = django_filters.CharFilter(lookup_expr='icontains', 
